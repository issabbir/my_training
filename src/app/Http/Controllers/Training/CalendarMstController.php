...
class CalendarMstController extends Controller
{
    use HasPermission;
    ...
    public function index(Request $request)
    {
        ...
        return view('training.calendar.calendar_mst.calendar', [
            'calendardata' => null,
    ...
    public function dataTableList()
    {
        ...
        return datatables()->of($queryResult)
            ...
            ->addColumn('action', function ($query) {
                return '<a href="' . route('calendar-mst.calendar-mst-edit', [$query->calender_id]) . '"><i class="bx bx-edit cursor-pointer"></i></a>';
            })
            ->addIndexColumn()
            ->make(true);
    }
    ...
    public function post(Request $request)
    {
        ...
        return redirect()->route('calendar-mst.calendar-mst-index');
    }
