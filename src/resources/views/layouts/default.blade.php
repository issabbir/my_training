...
<head>
	...
	<title>Training Institute Automation System @yield('title', 'Electricity and Water Billing Management System')</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/training-tab.css')}}">
    <!-- END: Page CSS-->
...
<script src="{{asset('assets/js/scripts/extensions/sweet-alerts-cust.min.js')}}"></script>
