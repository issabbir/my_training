    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <!-- Table Start -->
                <div class="card-body">
                    <h4 class="card-title">Trainee Evaluation</h4>
                    <hr>
            ...
            <div class="card">
                <div class="card-body"><h4 class="card-title">Evaluation List</h4>
                    <hr>
                    <div class="row">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#final-results-form').on('submit', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{route('trainee-evaluation.trainee-evaluation-post')}}",
                    data: $(this).serialize(),
                    success: function (data) {
        ...
        var oTable = $('#final-results').DataTable({
            ...
            ajax: {
                url: APP_URL+"/trainee-evaluation-datatable",
                'type': 'POST',
                'headers': {
